---
name: retro
description: "Post-work retrospective that closes the landed plan in the pm loop and harvests follow-ups and durable per-task decisions. Use at end of session after significant work, never mid-task."

...
- `codex/config.toml.template` `UserPromptSubmit` hooks missing `codex/hooks/inject-context.sh`, or its timeout is not exactly 30 seconds → FAIL (session binding must resolve within the prompt turn).

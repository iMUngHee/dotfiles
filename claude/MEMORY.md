...
- [AI config structure](memory/feedback_ai_config_structure.md) — `~/.config/ai/` layout, deploy model, prefix, manifest ordering, token substitution (consolidates 5 prior memories)

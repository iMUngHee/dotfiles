...
- **Notifications**: Task completion and approval requests trigger desktop notifications automatically via AgentNotifier (macOS or Linux). Do not send them manually (osascript/notify-send).

...
- **Auto-format**: After Edit/Write/MultiEdit, files are auto-formatted (prettier, gofmt, rustfmt, etc.). If you see "[auto-format]" output, the formatter changed the file — do not revert. Note: rapid successive edits within 30s may skip formatting due to debounce.
